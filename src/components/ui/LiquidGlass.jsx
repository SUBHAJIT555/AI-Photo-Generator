...
function createDisplacementMap(size, bezel) {
  ...
  return (
    <>
      <div
        ref={ref}
        className={cn(
          "relative overflow-hidden rounded-full border border-white/20 bg-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_0_rgba(255,255,255,0.5),inset_0_-1px_0_0_rgba(0,0,0,0.05)]",
          className
        )}
        style={{
          ...style,
